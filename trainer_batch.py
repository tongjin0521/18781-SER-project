    ...
    def __init__(self, params: configargparse.Namespace):
        ...
        if self.batch_enable:
            ...
            for fold_id in range(5):
                with open("inputdata/five_fold_"+str(fold_id+1)+"_train.json", "rb") as f:
                    train_json = json.load(f)
                with open("inputdata/five_fold_"+str(fold_id+1)+"_valid.json", "rb") as f:
                    valid_json = json.load(f)
                with open("inputdata/five_fold_"+str(fold_id+1)+"_test.json", "rb") as f:

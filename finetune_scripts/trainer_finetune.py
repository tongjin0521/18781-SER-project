...
from dataloader_finetune import create_loader_with_folds
from dataloader_finetune import _create_loader

from losses.mcc import MinimumClassConfusionLoss

from models.finetune import WavLMForCTCnCLS
...
class Trainer:
    def __init__(self, params: configargparse.Namespace):
        ...
        if self.params.finetune:
            print(f'finetune flow')
            self.model = WavLMForCTCnCLS(params)

...
def get_parser(parser=None, required=True):
    ...
    parser.add_argument(
        "--finetune", default=False, type=bool, help="use finetune model and finetune flow"
    )
    parser.add_argument(
        "--freeze_pretrain", default=False, type=bool, help="freeze the pretrain model in finetune flow"
    )
    parser.add_argument(
        "--pretrained_path", default="microsoft/WavLM-Base+.pt", type=str, help="pretrained checkpoint path"
    )
